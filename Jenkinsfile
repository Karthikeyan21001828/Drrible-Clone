pipeline {
    agent any
    environment {
        SONAR_TOKEN = "squ_584706b8ff792b2dc8aa83773e71d0d9d2719724" // Use the stored Jenkins credential
    }
    // triggers {
            ...
            steps {
                script {
                        ...
                        sonar-scanner \
                            ...
                            -Dsonar.sources=. \
                            -Dsonar.host.url=http://98.84.53.111:9000 \
        ...
        stage('SonarQube Quality Gate') {
            steps {
                script {
                    ...
                    def sonarQubeUrl = 'http://98.84.53.111:9000'
                    def sonarUser = 'admin'
